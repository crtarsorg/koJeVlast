	...
	<script src="static/script-index.js?<?php //echo rand(11111,99999); ?>"></script>
	<script src="static/data.js?6"></script> <!-- dependant from script-index -->
		<script src="viz/map.js?3"></script>
